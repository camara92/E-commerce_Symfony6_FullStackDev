...
class Orders
{
    ...
    #[ORM\Column]
    private ?int $id = null;
    // L'ajout de l'options vient par le fait que le maker bundle ne le met pas lors de la commande de création des propriétés de tables 
    
    #[ORM\Column(type:'datetime_immutable', options:['default'=>'CURRENT_TIMESTAMP'], length: 255)]
